...
//Dashboard
import Tableau from "./Components/doctor/Tableau";
...
import AddMedication from './pages/patient/medications/AddMedication';
import UpdateMedication from './pages/patient/medications/UpdateMedication';
import AllMedications from './pages/patient/medications/AllMedications';
        ...
        <ScrollToTop>
          <Routes>
            ...
            <Route
              path="/record-checker"
              element={
                <PrivateRoute component={RecordChecker} role={"patient"} />
              }
            />
            <Route
              path="phome"
              element={
                <PrivateRoute component={PatientHome} role={"patient"} />
              }
            />
            <Route
              path="/teleDoctor"
            ...
            <Route
              ...
              element={
                <PrivateRoute component={TeleDoctorEdit} role={"patient"} />
              }
            />
            <Route
              ...
              element={
                <PrivateRoute
                  component={TeleDoctorPreConfirm}
                  role={"patient"}
                />
              }
            />
            ...
            <Route
              ...
              element={
                <PrivateRoute
                  component={HomeDoctorPreConfirm}
                  role={"patient"}
                />
              }
            />
            ...
            <Route
              path="pmed"
              element={
                <PrivateRoute component={MedDelivery} role={"patient"} />
              }
            />
            <Route
              path="pmed/preconfirm"
              element={
                <PrivateRoute component={MedPreConfirm} role={"patient"} />
              }
            />
            <Route
              path="pmed/med-booking-confirmed"
              element={
                <PrivateRoute component={MedConfirmed} role={"patient"} />
              }
            />
            <Route
              path="dmed/accept"
            ...
            <Route
              ...
              element={
                <PrivateRoute component={Appointments} role={"patient"} />
              }
            />
            <Route
              path="profile"
            ...
            <Route
              ...
              element={
                <PrivateRoute component={ProfileConfirmed} role={"patient"} />
              }
            />
            <Route
              path="dhome"
            ...
            <Route
              path="dashboard"
              element={<PrivateRoute component={Tableau} role={"doctor"} />}
            />
            <Route
...
<Route path="/patient/medications/add" element={<AddMedication />} />
        <Route path="/patient/medications/update" element={<UpdateMedication />} />
        <Route path="/patient/medications/all" element={<AllMedications />} />
          </Routes>
        </ScrollToTop>
      </BrowserRouter>
    </>
